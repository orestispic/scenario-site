...
| 2 | API locale, authentification préparée et RLS | Site + app | Sol | SQL statique, API, droits, cache signé, builds | Réalisé localement ; exécution RLS réelle attend Supabase local | Supabase/Docker non disponibles |
