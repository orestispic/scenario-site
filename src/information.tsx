...
export function InformationPages() {
  return <>
    <section className="section help" id="support"><h2>Aide et support</h2>
      <p>Pour toute question sur la bêta privée, écrivez à <a href="mailto:support@senario.app">support@senario.app</a>.</p>
      ...
      <details><summary>Quitter la bêta ou demander vos données</summary><p>Adressez votre demande à <a href="mailto:support@senario.app">support@senario.app</a>. La suppression du compte n’est pas encore disponible en libre-service. Exportez vos projets et organisez le transfert des projets partagés avant de demander leur suppression.</p></details>
    </section>
    <section className="section help" id="confidentialite"><h2>Vos données dans la bêta</h2>
      ...
      <details><summary>Sessions et droits sur vos données</summary><p>Les jetons de connexion du site restent en mémoire jusqu’à la fermeture de la session. La prévisualisation privée utilise également l’authentification Vercel. Pour toute demande d’accès, de rectification, d’export ou de suppression, écrivez à <a href="mailto:support@senario.app">support@senario.app</a>. Vous pouvez adresser une réclamation à la CNIL.</p></details>
    ...
    <section className="section help" id="mentions"><h2>Mentions légales en préparation</h2>
      ...
      <p>Le site est hébergé chez Vercel. Contact : <a href="mailto:support@senario.app">support@senario.app</a>.</p>
    </section>
  </>;
}
